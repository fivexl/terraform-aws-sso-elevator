...
| <a name="input_cache_ttl_minutes"></a> [cache\_ttl\_minutes](#input\_cache\_ttl\_minutes) | TTL in minutes for cached AWS accounts and permission sets. If set to 0, caching is disabled and DynamoDB table will not be created. | `number` | `360` | no |
